...
use crate::pci_tdisp::{
    InterfaceId, ReqUnBindP2PStreamRequest, RspUnBindP2PStreamResponse, TdispErrorCode,
    TdispMessageHeader, TdispRequestResponseCode, TdispVersion,
};

use super::pci_tdisp_rsp_tdisp_error::write_error;

static PCI_TDISP_DEVICE_UNBING_P2P_STREAM_INSTANCE: OnceCell<PciTdispDeviceUnBindP2pStream> =
    OnceCell::uninit();
...
pub fn register(context: PciTdispDeviceUnBindP2pStream) -> bool {
    PCI_TDISP_DEVICE_UNBING_P2P_STREAM_INSTANCE
...
pub(crate) fn pci_tdisp_rsp_unbind_p2p_stream(
    ...
    let cnt = RspUnBindP2PStreamResponse {
