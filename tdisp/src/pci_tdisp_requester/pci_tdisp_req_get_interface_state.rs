...
use crate::pci_tdisp::pci_sig_vendor_id;
...
pub async fn pci_tdisp_req_get_interface_state(
    // IN
    ...
    if rsp_device_interface_state.message_header.tdisp_version != negotiated_version
